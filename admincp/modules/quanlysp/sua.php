  ...
  <form method="POST" action="modules/quanlysp/xuly.php?idsanpham=<?php echo $row['id_sanpham'] ?>"
    ...
    <tr>
      ...
      <td>
        ...
        <img src="modules/quanlysp/uploads/<?php echo $row['hinhanh1'] ?>" width="150px">
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        <img src="modules/quanlysp/uploads/<?php echo $row['hinhanh2'] ?>" width="150px">
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        <img src="modules/quanlysp/uploads/<?php echo $row['hinhanh3'] ?>" width="150px">
      </td>
