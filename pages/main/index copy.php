        ...
        <div class="products">
          ...
          <div class="thumbnail">
            <a href="index.php?quanly=sanpham&id=<?php echo $row['id_sanpham'] ?>">
              ...
              <img src="admincp/modules/quanlysp/uploads/<?php echo $row['hinhanh'] ?>" alt="Product Name"></a>
          </div>
          <div class="productname"><?php echo $row['tensanpham'] ?></div>
          <h4 class="price"><?php echo number_format($row['giasp'],0,',','.').'vnđ' ?></h4>
